	...
	if (user.data.id === owner) {
		return (
			<div className="bg-foreground bg-opacity-80 h-fit min-h-full rounded-md mt-24">
				...
				<div className="ml-2 mt-5 flex flex-row justify-start">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
					...
					{description ? (
						<p className="self-center justify-center ml-2 text-sm font-bold leading-9 tracking-tight text-white">
							{description} OR
						</p>
					) : (
						<p className="self-center justify-center ml-2 text-sm font-bold leading-9 tracking-tight text-white">
				...
				<div className="ml-2 mb-2 p-1 justify-start">
					...
					<div className="flex flex-row justify-start">
						...
						<Popup
							...
							trigger={
								<span>
									<button className="ml-3 text-center text-sm leading-9 font-semibold tracking-tight text-white hover:text-orange-400 self-center justify-center">
										Add Members
									</button>
								</span>
							}
