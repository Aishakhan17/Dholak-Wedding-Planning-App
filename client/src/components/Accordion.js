...
const Accordion = ({ title, data, boardId}) => {
    ...
    return (
        <div className="ml-2 py-2">
            ...
            >
                <span className="text-sm font-bold leading-9 tracking-tight text-white">{title}</span>
                <svg
                    ...
                    {Object.keys(data).map((i, j) => {
                        ...
                        return (
                            <div className="mt-2 overflow-hidden w-full flex justify-start" key={j}>
                                ...
                                <a href={`/board/${id}`} className="p-3 ml-2 justify-center self-center flow-root text-sm leading-9 tracking-tight text-white">{name}</a>
                            </div>
                        )
                    })}
                </div>
